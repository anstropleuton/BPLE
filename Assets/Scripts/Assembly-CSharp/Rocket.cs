...
public class Rocket : BasePropulsion
{
	...
	private void INFixedUpdate()
	{
		...
		foreach (BasePart part in base.contraption.Parts)
		{
			...
			if (!MarkerManager.IsInSameTeamStatic(this, part) && part.m_partType != PartType.Rope && part.gameObject.layer != num24 && magnitude < num20 && vector4.x * vector3.x + vector4.y * vector3.y > num23 * magnitude)
			{
